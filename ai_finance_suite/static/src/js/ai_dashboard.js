    ...
    async fetchData() {
        ...
        try {
            this.state.data = await this.orm.call(
                "af.finance.dashboard", "get_dashboard_data", [],
...
AIFinanceAnalytics.template = "ai_finance_suite.Analytics";
registry.category("actions").add("ai_finance_suite.analytics_action", AIFinanceAnalytics);
