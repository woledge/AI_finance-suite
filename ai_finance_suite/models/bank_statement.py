...
class BankStatement(models.Model):
    ...
    # Lines
    line_ids = fields.One2many('af.bank.statement.line', 'statement_id', string='Statement Lines')
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get('name', 'New') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code('af.bank.statement') or 'New'
    ...
    def action_print_report(self):
        ...
        return self.env.ref('ai_finance_suite.action_report_bank_statement').report_action(self)


class BankStatementLine(models.Model):
    _name = 'af.bank.statement.line'
    _description = 'Bank Statement Line'
    _order = 'date, id'

    statement_id = fields.Many2one('af.bank.statement', string='Statement', ondelete='cascade')
